...

                {
                    isComingSoon && (
                        <div
                            ...
                            onMouseLeave={handleMouseLeave}
                            className='border-amber-50 relative flex w-fit cursor-pointer items-center gap-1 overflow-hidden rounded-full bg-black px-5 py-2 text-xs uppercase text-white/20'
                        >
    ...
    return (
        <section className='bg-black pb-52'>
            <div className='container mx-auto px-3 md:px-10'>
                ...
                <div className='grid h-[135vh] grid-flow-col w-full grid-cols-2 grid-rows-3 gap-7'>
